...
public class ChatHisAdapter extends RecyclerView.Adapter<ChatHisAdapter.ViewHolder> implements OnMoveAndSwipeListener {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final ChatHisAdapter.ViewHolder recyclerViewHolder = (ChatHisAdapter.ViewHolder) holder;
        ...
        holder.sendMsg.setText("内容：" + chatHis.getSendMsg());
        try {
    ...
    public void onItemDismiss(final int position) {
        ...
        Snackbar.make(view, mContext.getString(R.string.delete_his_item), Snackbar.LENGTH_SHORT).setAction("UNDO", v -> addItem(position, chatHisList.get(position))).show();
    }
